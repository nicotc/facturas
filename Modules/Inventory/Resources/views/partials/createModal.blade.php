        ...
        <form autocomplete="off" wire:submit.prevent="add()">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h5 class="modal-title" id="exampleModalLabel">Crear nuevo producto para el inventario</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="quantity" wire:model="stock">
                        @error('quantity') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="quantity">Cantidad minima</label>
                        <input type="number" class="form-control" id="quantity" wire:model="stock_alert">
                        @error('quantity') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
