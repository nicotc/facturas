                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group mb-3">
                            ...
                            <button type="button" class="btn btn-default" wire:click='deleteId({{$item->id}})' data-toggle="modal" data-target="#delete">
...
@include('inventory::partials.createModal')
@include('inventory::partials.editModal')
@include('inventory::partials.deleteModal')
