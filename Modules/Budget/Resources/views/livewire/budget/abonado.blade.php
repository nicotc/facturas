                    ...
                    <div class="card-body">
                        <div class="col-12">
                            <div class="progress">
                                ...
                                @endphp
                                <div class="progress-bar progress-bar-striped" role="progressbar" style="width: {{$porcentaje}}%"
                                    aria-valuenow="{{$totalAbonado}}" aria-valuemin="0" aria-valuemax="{{ $totalPagar }}">{{$porcentaje}}%</div>
                            </div>
                        </div>
                        <div class="col-12">
                            <table class="table">
