    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="proveedor">Proveedor / Trabajador :</label>
                    <input type="proveedor" wire:model="proveedor" class="form-control" name="proveedor" id="proveedor"
                ...
                <div class="form-group">
                    <label for="total">Total</label>
                    <input type="text" wire:model="total" class="form-control" name="total" id="total"
                        placeholder="total">
                    @error('total') <span class="error text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
                    <label for="abono">Abono</label>
                    <input type="text" wire:model="abono" class="form-control" name="abono" id="abono"
                        placeholder="abono">
                    @error('abono') <span class="error text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
                    <label for="estado">Estado</label>
                    <input type="text" wire:model="estado" class="form-control" name="estado" id="estado"
                        placeholder="estado">
                    @error('estado') <span class="error text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="form-group">
